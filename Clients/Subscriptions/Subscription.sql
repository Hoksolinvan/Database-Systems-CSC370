...
create table `Subscriptions`(`ClientID` INT, `SubscriptionID` varchar(10) unique, 
`ServiceType` varchar(150), `SubscriptionDate` date, `SubScriptionStatus` enum('Active', 'Inactive', 'Cancelled', 'Pending'), `MonthlyFee` varchar(8) default '$0.00'); 
